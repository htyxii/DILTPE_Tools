...
<body>
  ...
  <img src="Dimerco-Logo-For-Resources-1.jpg" class="vw-100" alt="Girl in a jacket" >
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-12 px-md-4">
        ...
        <canvas class="my-4 w-100 chartjs-render-monitor" id="myChart" width="781" height="328" style="display: block; height: 219px; width: 521px;"></canvas>
